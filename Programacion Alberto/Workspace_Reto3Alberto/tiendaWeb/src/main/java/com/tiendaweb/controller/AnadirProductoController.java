...
public class AnadirProductoController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Part archivoImagen = request.getPart("rutaImagen");
		if (archivoImagen.getSize() > 0) {
			...
			// y se concatena con "imagenes", que es el nombre de la carpeta donde se
			...
			// "rutaImagen" es el nombre del input del formulario
			...
			// Se utiliza el contexto de la aplicación y se concatena la carpeta y el nombre
			// de la imagen
			rutaWeb = request.getContextPath() + "/imagenes/" + nombreImagen;
		} else {
			rutaWeb = request.getParameter("rutaImagenAntigua");
		}
