...
public class JuegoUI extends JFrame {
	...
	public JuegoUI(Personaje clase, Personaje enemigo) {
		...
		BarraSaludEnemigo.setStringPainted(true);
		...
		JLabel lblAtaqueJugador_Total = new JLabel(String.valueOf(clase.getAtaqueMin() + "-" + clase.getAtaqueMax()));
		...
		JLabel lblAtaqueEnemigo_Total = new JLabel(
				String.valueOf(enemigo.getAtaqueMin() + "-" + enemigo.getAtaqueMax()));
		...
		scrollPane.setBounds(10, 231, 439, 108);
		getContentPane().add(scrollPane);

		JTextArea InformacionCombate = new JTextArea();
		scrollPane.setViewportView(InformacionCombate);
		InformacionCombate.setEditable(false);
		InformacionCombate.setTabSize(150);
		InformacionCombate.setAutoscrolls(true);
